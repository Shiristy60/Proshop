...
export const userDeleteReducer = (state = {}, action) => {
    switch (action.type) {
        case USER_DELETE_REQUEST:  // make a request for user
            return {loading: true}
        case USER_DELETE_SUCCESS:  // a successful response from server
            return { loading: false, success: true }
        case USER_DELETE_FAIL:     // a failed response(error) from server
            return { loading: false, error: action.payload }
        default:
            return state
    }
...
export const userUpdateReducer = (state = { user: {} }, action) => {
    switch (action.type) {
        case USER_UPDATE_REQUEST:  // make a request for user
            return { loading: true }
        case USER_UPDATE_SUCCESS:  // a successful response from server
            return { loading: false, success: true }
        case USER_UPDATE_FAIL:     // a failed response(error) from server
            return { loading: false, error: action.payload }
